...
abstract class PermissionRepository {
  ...
  Future<Either<Failure, List<Permission>>> getPermissionsForResource(
    String resource,
  );
  ...
  Future<Either<Failure, void>> cacheUserPermissions(
    UserPermissionContext context,
  );

  /// Get cached user permissions
  Future<Either<Failure, UserPermissionContext?>> getCachedUserPermissions(
    String userId,
  );
