...
class PermissionService {
  ...
  Future<Map<String, bool>> checkMultiplePermissions(
    ...
    final result = await checkMultiplePermissionsUseCase(
      CheckMultiplePermissionsParams(userId: userId, permissionChecks: checks),
    );
  ...
  Future<bool> canCreateProjects(String userId) =>
      canCreate(userId, 'projects');
  Future<bool> canUpdateProjects(String userId) =>
      canUpdate(userId, 'projects');
  Future<bool> canDeleteProjects(String userId) =>
      canDelete(userId, 'projects');
  Future<bool> canManageProjects(String userId) =>
      canManage(userId, 'projects');

  /// Daily reports permission checks
  Future<bool> canViewDailyReports(String userId) =>
      canView(userId, 'daily_reports');
  Future<bool> canCreateDailyReports(String userId) =>
      canCreate(userId, 'daily_reports');
  Future<bool> canUpdateDailyReports(String userId) =>
      canUpdate(userId, 'daily_reports');
  Future<bool> canDeleteDailyReports(String userId) =>
      canDelete(userId, 'daily_reports');

  /// Work calendar permission checks
  Future<bool> canViewWorkCalendar(String userId) =>
      canView(userId, 'work_calendar');
  Future<bool> canCreateWorkEvents(String userId) =>
      canCreate(userId, 'work_calendar');
  Future<bool> canUpdateWorkEvents(String userId) =>
      canUpdate(userId, 'work_calendar');
  Future<bool> canDeleteWorkEvents(String userId) =>
      canDelete(userId, 'work_calendar');
  ...
  Future<bool> canViewWorkRequests(String userId) =>
      canView(userId, 'work_requests');
  Future<bool> canCreateWorkRequests(String userId) =>
      canCreate(userId, 'work_requests');
  Future<bool> canApproveWorkRequests(String userId) =>
      hasPermission(userId, 'work_requests', 'approve');
  Future<bool> canRejectWorkRequests(String userId) =>
      hasPermission(userId, 'work_requests', 'reject');
}
