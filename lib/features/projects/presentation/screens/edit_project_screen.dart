...
class EditProjectScreen extends StatefulWidget {
  const EditProjectScreen({super.key, required this.project, required this.user});
...
class _EditProjectScreenState extends State<EditProjectScreen> {
  ...
  Widget build(BuildContext context) {
    return ElevatedAccessWidget(user: widget.user, fallback: _buildAccessDeniedView(), child: _buildEditForm());
  }
  ...
  Widget _buildEditForm() {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Project'),
        backgroundColor: Theme.of(context).colorScheme.surfaceContainerHighest,
        actions: [IconButton(onPressed: _saveProject, icon: const Icon(Icons.save), tooltip: 'Save Changes')],
      ),
  ...
  Widget _buildStatusDropdown() {
    final statusOptions = ['Planning', 'In Progress', 'On Hold', 'Completed', 'Cancelled'];
