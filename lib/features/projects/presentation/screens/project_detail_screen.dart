...
import '../../domain/entities/project.dart' as legacy;
...
/// Project detail screen with role-based access and comprehensive features
...
class _ProjectDetailScreenState extends State<ProjectDetailScreen> with TickerProviderStateMixin {
  ...
  /// Convert API Project to legacy Project for widgets that expect the old format
  legacy.Project _convertToLegacyProject(Project apiProject) {
    return legacy.Project(
      projectId: apiProject.projectId,
      projectName: apiProject.projectName,
      address: apiProject.address,
      clientInfo: apiProject.clientInfo,
      status: apiProject.status,
      startDate: apiProject.startDate,
      estimatedEndDate: apiProject.estimatedEndDate,
      actualEndDate: apiProject.actualEndDate,
      createdAt: apiProject.createdAt,
      updatedAt: apiProject.updatedAt,
      description: '', // API Project doesn't have description field
      priority: legacy.ProjectPriority.medium, // Default priority
      projectManager: null, // Convert ProjectManager to User if needed
  ...
  void _onEditProject(Project project) {
    if (_currentUser != null) {
      final legacyProject = _convertToLegacyProject(project);

      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => EditProjectScreen(project: legacyProject, user: _currentUser!),
        ),
      );
    }
  }
          ...
          builder: (context, authState) {
            ...
            return BlocBuilder<ProjectBloc, ProjectState>(
              builder: (context, projectState) {
                ...
                if (projectState is ProjectDetailsLoaded) {
  ...
  Widget _buildProjectDetailContent(Project project) {
    return Scaffold(
      body: NestedScrollView(
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            ProjectHeaderWidget(
              project: _convertToLegacyProject(project),
  ...
  List<Widget> _buildTabContent(Project project) {
    final tabs = <Widget>[
      ...
      SingleChildScrollView(
        ...
        child: ProjectDetailsWidget(project: _convertToLegacyProject(project)),
      ),
