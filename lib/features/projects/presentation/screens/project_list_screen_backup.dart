// This file has been refactored into focused components
// Use the new refactored version: project_list/project_list_screen.dart
export 'project_list/project_list_screen.dart';
...
class _ProjectListScreenState extends State<ProjectListScreen> {
  ...
  void _checkAuthAndInitializeIfAuthenticated() {
    ...
    if (authState is AuthAuthenticated) {
      ...
      // Don't try to load projects if not authenticated
  ...
  void _cleanupUnauthenticatedServices() {
    debugPrint('🧹 Project List: Cleaning up services for unauthenticated user');
    ...
    debugPrint('🛑 Project List: Cancelled app focus subscription');
    ...
    // Clear any existing project data - but don't trigger new API calls
    if (mounted) {
      debugPrint('🗑️ Project List: Clearing project data due to unauthenticated state');
      // Note: Don't use RefreshProjectsWithCacheClear here as it will try to make API calls
      // The auth system will handle redirecting to login
    }
  }
  ...
  void _loadInitialProjectsWithFreshData() {
    ...
    debugPrint('🚀 Project List: Loading initial projects with fresh API data');
  ...
  void _handleAuthenticationError() {
    ...
    debugPrint('🚨 Project List: Handling authentication error');
