...
mixin ProjectDatabaseSyncMixin<T extends StatefulWidget> on State<T> {
  ...
  void forceDatabaseSync() {
    ...
    context.read<ProjectBloc>().add(RefreshProjectsWithCacheClear(query: currentQuery));
  ...
  void _loadFreshData(ProjectsQuery currentQuery) {
    ...
    if (searchTerm.isNotEmpty) {
      context.read<ProjectBloc>().add(SearchProjectsRequested(searchTerm: searchTerm, filters: currentQuery));
    } else {
      context.read<ProjectBloc>().add(LoadProjectsRequested(query: currentQuery));
    }
  }
