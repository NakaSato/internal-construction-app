    ...
    switch (update.type) {
      case 'create':
        if (update.project != null) {
          context.read<ProjectBloc>().add(RealTimeProjectCreatedReceived(project: update.project!));
        } else {
          onSilentRefresh();
        }
        break;
      case 'update':
        if (update.project != null) {
          context.read<ProjectBloc>().add(RealTimeProjectUpdateReceived(project: update.project!));
        } else {
          onSilentRefresh();
        }
        break;
