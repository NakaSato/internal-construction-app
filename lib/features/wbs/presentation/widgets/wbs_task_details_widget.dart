              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (task!.wbsCode.isNotEmpty) const SizedBox(height: 8),

                    // Task Name
                    Text(task!.taskName, style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
  ...
  Widget _buildDatesSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow(context, 'Start Date', _formatDate(task!.startDate)),
        _buildInfoRow(context, 'End Date', _formatDate(task!.endDate)),
          ...
          (child) => Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Text(child.taskName, style: theme.textTheme.bodyMedium)),
                Text(
