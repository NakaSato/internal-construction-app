      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getProgressColor(progress * 100 ~/ 1).withOpacity(0.2),
            ...
            if (project.totalTasks != null && project.completedTasks != null) ...[
              Row(
            ...
            Row(
              children: [
                Icon(
                  ...
                  color: isOverBudget ? theme.colorScheme.error : theme.colorScheme.tertiary,
                ),
                const SizedBox(width: 8),
                Text(
                  'Budget',
