...
class CreateProjectRequest {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (locationCoordinates != null) 'locationCoordinates': locationCoordinates,
    };
  }
}
...
class UpdateProjectRequest {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (estimatedEndDate != null) json['estimatedEndDate'] = estimatedEndDate!.toIso8601String();
    if (actualEndDate != null) json['actualEndDate'] = actualEndDate!.toIso8601String();
    ...
    if (locationCoordinates != null) json['locationCoordinates'] = locationCoordinates;
